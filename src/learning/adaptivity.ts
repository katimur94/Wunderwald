...
export const LEVEL_DESCRIPTIONS: Record<WorldId, Record<number, string>> = {
  zahlen: {
    ...
    2: 'Zählt sicher bis 6 und ordnet Menge und Zahl einander zu.',
    3: 'Zählt sicher bis 20, vergleicht Mengen, erste Plusaufgaben bis 10.',
    4: 'Lässt sich beim Zählen nicht mehr ablenken, rechnet plus und minus bis 10.',
    ...
    7: 'Ergänzt zu vollen Zehnern und löst Aufgaben mit fehlenden Zahlen.',
    8: 'Kennt das kleine Einmaleins der 2er-, 5er- und 10er-Reihe.',
    9: 'Rechnet das kleine Einmaleins gemischt und löst kleine Sachaufgaben.',
    10: 'Rechnet mehrschrittig mit Klammern und denkt sich in Textaufgaben hinein.',
  },
  buchstaben: {
    1: 'Hört erste Anlaute heraus und erkennt einzelne große Buchstaben.',
    2: 'Ordnet mehreren Bildern den richtigen Anfangsbuchstaben zu.',
    3: 'Erkennt die häufigen Anlaute sicher, auch bei mehr Auswahl.',
    4: 'Unterscheidet ähnlich klingende Laute wie B und P oder D und T.',
    5: 'Hört nicht nur den Anfang, sondern auch den letzten Laut eines Wortes.',
    6: 'Findet fehlende Buchstaben im Wort und baut Wörter aus Silben.',
    7: 'Verbindet Groß- und Kleinbuchstaben sicher miteinander.',
    8: 'Setzt Wörter aus einzelnen Buchstaben zusammen, auch mit Ablenkern.',
    9: 'Liest erste kurze Wörter selbst und ordnet ihnen das richtige Bild zu.',
    10: 'Liest kurze Sätze und ergänzt fehlende Wörter sinnvoll.',
  },
  logik: {
    1: 'Setzt einfache Farbmuster fort (rot, blau, rot, blau …).',
    ...
    5: 'Bezieht die Größe von Dingen als weiteres Merkmal mit ein.',
    6: 'Behält zwei Merkmale gleichzeitig im Blick, z. B. Farbe und Form.',
    7: 'Erkennt Zahlenreihen und rechnet den nächsten Schritt aus.',
    8: 'Durchschaut auch Reihen mit Sprüngen, Rückwärtsschritten und Verdopplung.',
    9: 'Löst kleine Denk-Matrizen, bei denen ein Feld fehlt.',
    10: 'Kombiniert mehrere Regeln gleichzeitig und begründet seine Wahl.',
  },
}
